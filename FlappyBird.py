...
class FlappyBird:
    def __init__(self):
        self.x_size = 25
        self.y_size = 25
        self.flap = pygame.transform.scale(pygame.image.load('tools/Bird.png'), (self.x_size, self.y_size))
        self.x = 250
        self.y = 150
        self.y_speed = 0
...
class Columns:
    def __init__(self):
        ...
        self.obstacle_down = pygame.transform.scale(pygame.image.load('tools/Column.png').convert_alpha(),
                                                    (self.width, self.height + 200))
        self.obstacle_up = pygame.transform.scale(pygame.transform.flip
                                                  (pygame.image.load('tools/Column.png'), False, True),
                                                  (self.width, self.height + 200))
...
def draw_sky():
    width = 700
    height = 500
    sky = pygame.transform.scale(pygame.image.load('tools/Sky.png').convert_alpha(), (width, height))
    win.blit(sky, (0, 0))
...
def draw_ground():
    width = 700
    height = 100
    ground = pygame.transform.scale(pygame.image.load('tools/Ground.png').convert_alpha(), (width, height))
...
def game_over():
    image = pygame.transform.scale(pygame.image.load('tools/GameOver.png').convert_alpha(), (200, 120))
